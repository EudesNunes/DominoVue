<template>
  <div class="body">
    <div class="principal">
      <div
        class="COMPRA"
        v-show="precisacomprar && Algoritmo.getPecasCompra.length != 0"
      >
        <div
          v-for="item in Algoritmo.getPecasCompra"
          :key="item"
      ...
      <div class="topo">
        ...
        >
          <div class="caixa">
            <div
              v-for="item in Algoritmo.getPecasMaoIA"
              :key="item"
              style="margin-right: 5px"
            >
      ...
      <div class="embaixo">
        ...
        >
          ...
          <div class="caixa">
            <div
              v-for="item in Algoritmo.getPecasMaoJogador1"
              :key="item"
              style="margin-right: 5px"
...
export default defineComponent({
  ...
  setup(props) {
    ...
    function ComprarPeca(data) {
      ...
      if (
        Algoritmo.numerospossiveis.indexOf(peca.L1) != -1 ||
